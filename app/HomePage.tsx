...
const UserCard = (props: IUserCardProps) => {
    return (
        <TouchableOpacity onPress={() => {props.navigation.navigate("StrollDetail", {strollId: props.strollId})}} style={{backgroundColor: "#F8F8F8", borderWidth:1, borderRadius: 10, margin: 16,
