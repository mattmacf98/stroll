            ...
            }
            {
                ...
                <View style={{flex: 4, alignItems: "center", flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', padding: 32}}>
                    {strolls.map((stroll, index) => (
                        <TouchableOpacity key={index} onPress={() => {navigation.navigate("StrollDetail", {strollId: stroll._id})}} style={{backgroundColor: "#F8F8F8", borderWidth:1, borderRadius: 10, margin: 16,
